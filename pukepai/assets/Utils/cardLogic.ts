...
export default class CardLogic {
    ...
    static IsThreeAndOne(cardList) {
        ...
        if (countMap[countMapKeys[0]] == 3 && countMap[countMapKeys[1]] == 1 || countMap[countMapKeys[0]] == 1 && countMap[countMapKeys[1]] == 3) {
            return true;
        }
    };
